...
def train_model():
    # завантаження даних
    train_ds = tf.keras.preprocessing.image_dataset_from_directory('data_hw/train',
                                                                        image_size=(128,128),
                                                                        batch_size=30,
                                                                        label_mode='categorical',)
    test_ds = tf.keras.preprocessing.image_dataset_from_directory('data_hw/test',
                                                                        image_size=(128,128),
                                                                        batch_size=30,
                                                                        label_mode='categorical',)
    ...
    # 4-й, 256 - текстури, кольори, великі частини об'єктів
    model.add(layers.Conv2D(
        filters=256,
        kernel_size=(3, 3),
        activation='relu'
    ...
    # перевірка
    predict_image("images/banana.jpg", model) # banana

    # збереження моделі
    model.save('models/model_hw.h5')
...
if __name__ == '__main__':
    # train_model()
    predict_image('images/banana.jpg', load_model('models/model_hw.h5')) # Модель визначила: banana